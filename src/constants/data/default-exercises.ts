...
import { CoreType, ExerciseInputs, Field, ParentStatus } from '@/constants/model'
 ...
 */
const defaultExercises: IDBParent[] = [
  {
    [Field.TYPE]: CoreType.EXERCISE_PARENT,
  ...
  },
  {
    ...
    [Field.CREATED_TIMESTAMP]: 1641013200000,
    [Field.PARENT_STATUS]: ParentStatus.ENABLED,
    [Field.NAME]: 'Laying Tricep Extension',
    [Field.DESCRIPTION]: 'TODO DESCRIPTION',
    [Field.EXERCISE_INPUTS]: [
      ExerciseInputs.MULTIPLE_SETS,
      ExerciseInputs.WEIGHT_LBS,
  ...
  },
  {
    ...
    [Field.CREATED_TIMESTAMP]: 1641013200000,
    [Field.PARENT_STATUS]: ParentStatus.ENABLED,
    [Field.NAME]: 'Underhand Bicep Curls',
    [Field.DESCRIPTION]: 'TODO DESCRIPTION',
    [Field.EXERCISE_INPUTS]: [
      ExerciseInputs.MULTIPLE_SETS,
      ExerciseInputs.WEIGHT_LBS,
  ...
  },
  {
    ...
    [Field.CREATED_TIMESTAMP]: 1641013200000,
    [Field.PARENT_STATUS]: ParentStatus.ENABLED,
    [Field.NAME]: 'Doorway Chest Stretch (20 count)',
    [Field.DESCRIPTION]: 'TODO DESCRIPTION',
    [Field.EXERCISE_INPUTS]: [ExerciseInputs.CONFIRMATION],
  },
  {
    ...
    [Field.CREATED_TIMESTAMP]: 1641013200000,
    [Field.PARENT_STATUS]: ParentStatus.ENABLED,
    [Field.NAME]: 'Bent To Open Hand Stretch',
    [Field.DESCRIPTION]: 'TODO DESCRIPTION',
    [Field.EXERCISE_INPUTS]: [ExerciseInputs.MULTIPLE_SETS, ExerciseInputs.REPS],
  },
  {
  ...
  },
  {
    ...
    [Field.CREATED_TIMESTAMP]: 1641013200000,
    [Field.PARENT_STATUS]: ParentStatus.ENABLED,
    [Field.NAME]: 'Laying Glute Stretch (30 seconds each)',
    [Field.DESCRIPTION]: 'TODO DESCRIPTION',
    [Field.EXERCISE_INPUTS]: [ExerciseInputs.CONFIRMATION],
  },
  {
  ...
  {
    [Field.TYPE]: CoreType.EXERCISE_PARENT,
    [Field.ID]: '6ddbf5c0-a911-4586-b7dd-32031bc73871',
    [Field.CREATED_TIMESTAMP]: 1641013200000,
    [Field.PARENT_STATUS]: ParentStatus.ENABLED,
    [Field.NAME]: 'High Knees',
    [Field.DESCRIPTION]: 'TODO DESCRIPTION',
    [Field.EXERCISE_INPUTS]: [
      ExerciseInputs.MULTIPLE_SETS,
      ExerciseInputs.WEIGHT_LBS,
  ...
  },
  {
    ...
    [Field.CREATED_TIMESTAMP]: 1641013200000,
    [Field.PARENT_STATUS]: ParentStatus.ENABLED,
    [Field.NAME]: 'Back Parallel Foam Role (90 seconds)',
    [Field.DESCRIPTION]: 'TODO DESCRIPTION',
    [Field.EXERCISE_INPUTS]: [ExerciseInputs.CONFIRMATION],
  },
  {
  ...
  {
    [Field.TYPE]: CoreType.EXERCISE_PARENT,
    [Field.ID]: 'b4c36c38-94b2-4a68-9505-0478df1298ee',
    [Field.CREATED_TIMESTAMP]: 1641013200000,
    [Field.PARENT_STATUS]: ParentStatus.ENABLED,
    [Field.NAME]: 'Chest Side Pulls',
    [Field.DESCRIPTION]: 'TODO DESCRIPTION',
    [Field.EXERCISE_INPUTS]: [
      ExerciseInputs.MULTIPLE_SETS,
      ExerciseInputs.WEIGHT_LBS,
  ...
  },
  {
    ...
    [Field.CREATED_TIMESTAMP]: 1641013200000,
    [Field.PARENT_STATUS]: ParentStatus.ENABLED,
    [Field.NAME]: 'Back Perpendicular Foam Role (90 seconds)',
    [Field.DESCRIPTION]: 'TODO DESCRIPTION',
    [Field.EXERCISE_INPUTS]: [ExerciseInputs.CONFIRMATION],
  },
]
